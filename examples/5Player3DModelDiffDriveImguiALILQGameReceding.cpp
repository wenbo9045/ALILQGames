...
int main(){
    ...
    VectorXd umin = -1.0*VectorXd::Ones(nu*n_ag);
    VectorXd umax =  1.0*VectorXd::Ones(nu*n_ag);
    ...
    x0 << 
        0.5, 1.5,     M_PI/7.0,        // Agent 1
        1.0, 0.5,     M_PI/3.0,        // Agent 2
        2.0, 0.0,     M_PI/2.0,        // Agent 3
        3.0, 0.5, 2.0*M_PI/3.0,        // Agent 4
        3.5, 1.5, 6.0*M_PI/7.0;        // Agent 5
    ...
    xgoal << 
        ...
        3.0, 3.25,     M_PI/3.0,     
        2.0, 3.75,     M_PI/2.0,
        1.0, 3.25, 2.0*M_PI/3.0,
        0.5, 2.5, 6.0*M_PI/7.0;
