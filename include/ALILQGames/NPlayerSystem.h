...
class NPlayerSystem : public NPlayerModel {
    ...
    public:
        ...
        VectorXd dynamics_concat(const VectorXd &x, const VectorXd &u) override {
        ...
        void dynamicsJacobConcat(MatrixXd &fx, MatrixXd &fu, const VectorXd& x, const VectorXd& u) override {
